            ...
            <Section id={"about-me"}>
                <div className="w-screen h-[900px] sm:h-screen flex flex-wrap sm:flex-nowrap justify-center sm:justify-between items-center">
                    ...
                    <div className="w-11/12 sm:w-4/6 h-full sm:h-4/5 flex flex-col items-center">
                        <SectionTitle width={"responsive-width"}>
                            Sobre mí
                        </SectionTitle>
                        <AboutMe />
                        <a
                    ...
                    <div className="w-full h-5/6 flex flex-wrap justify-center items-start">
                        ...
                        <div className="w-11/12 h-4/5 flex gap-6 overflow-x-auto snap-x snap-mandatory relative scrollbar-x p-2">
                            <ProyectCard
                                ...
                                title={"LiftUp"}
                                codeHref={
                                    "https://github.com/matgarfer499/LiftUp"
                                }
                                tryHref={""}
                                tags={LiftUp}
                            >
                                Trabajo de fin de grado para el grado superior
                                de desarrollos de aplicaciones web.
                                <br />
                                Esta página simularía una tienda para comprar
                                ropa deportiva.
                            </ProyectCard>
                            <ProyectCard haveTry
                                image={"calculator"}
                                ...
                                codeHref={
                                    "https://github.com/matgarfer499/react-calculator"
                                }
                                tryHref={
                                    "https://matgarfer499.github.io/react-calculator/"
                                }
                                tags={calculator}
                            >
                                Primer proyecto hecho con React imitando la
                                apariencia y funcionalidades básicas de una
                                calculadora de un dispositivo Iphone.
                            </ProyectCard>
                            <ProyectCard
                                image={"enerclic"}
                                ...
                                tags={test}
                            >
                                Prueba técnica de PHP que se basa en crear una
                                API, almacenar esos datos en la base de datos
                                cuando se hace una busqueda y mostrar la media
                                comparando dos contadores a traves de una
                            ...
                            <ProyectCard haveTry
                                ...
                                title={"Reloj digital"}
                                codeHref={
                                    "https://github.com/matgarfer499/Reloj-con-JS"
                                }
                                tryHref={
                                    "https://matgarfer499.github.io/Reloj-con-JS/"
                                }
                                tags={watch}
                            >
                                Reloj en el que se puede cambiar entre modo
                                oscuro y claro usando clases de CSS. Tambien se
                                puede cambiar la forma en que se expone la hora,
                                ya sea como un reloj digital o uno clásico con
                                manecillas
                            </ProyectCard>
                            <ProyectCard haveTry
                                ...
                                codeHref={
                                    "https://github.com/matgarfer499/Calculadora-con-JS"
                                }
                                tryHref={
                                    "https://matgarfer499.github.io/Calculadora-con-JS/"
                                }
                                tags={calculatorClass}
                            >
                                Trabajo de clase de la asignatura de desarrollo
                                de aplicaciones en entorno cliente. <br />
                                Se trata de otra calculadora con métodos básicos
                                y científicos.
                            </ProyectCard>
                        </div>
                    </div>
            ...
            <Section id={"contact"}>
                <div className="w-full h-[500px] sm:h-full flex flex-col justify-center items-center">
                    ...
                    <footer className="mt-auto border-t-2 border-white/50 text-white/50 w-full flex justify-between items-center py-4 px-0 sm:px-4 text-xs">
                        <span>
                            &copy; 2023 Matías José García Fernández. Todos los
                            derechos reservados.
                        </span>{" "}
